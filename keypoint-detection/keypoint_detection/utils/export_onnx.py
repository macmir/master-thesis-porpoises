...
model = ConvNeXtUnet().cuda()
state_dict = torch.load('/home/maciek/Documents/Studia/Magisterka/master-thesis/kp/model.ckpt')
...
torch.onnx.export(model,x, 'convnxt.onnx', input_names=['input'], output_names=['output'], verbose=True)
