...
# images
# path = '/home/maciek/Documents/Studia/Magisterka/master-thesis/coco_dataset/labeled_train/output' # additional 170
path = '/home/maciek/Documents/Studia/Magisterka/master-thesis/testy/data/labelbox/output' # original 
files = os.listdir(path)
files.sort()

# file with annotations
# labels = pd.read_json('/home/maciek/Documents/Studia/Magisterka/master-thesis/coco_dataset/labeled_train/results.json') # additional 170
labels = pd.read_json('/home/maciek/Documents/Studia/Magisterka/master-thesis/testy/data/labelbox/output.json') # original



save_path = '/home/maciek/Documents/Studia/Magisterka/master-thesis/coco_dataset/real_training'
name_increment = 0
annotations_file = {}
...
save_file = open('json_with_keypoints_labeled_train170r.json', 'w')
