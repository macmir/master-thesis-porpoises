...
with open('/home/maciek/Documents/Studia/Magisterka/master-thesis/kp/keypoint-detection/processing_images/json_with_keypoints_labeled_train170r.json') as f:
...
for image_name, keypoints in data.items():
    ...
    coco_data['images'].append({
        "id": image_id,
        "license": 1,
        "file_name": 'real_training/' + image_name,
        "width": 128, 
        "height": 128, 
    })
...
with open('real_train_170.json', 'w') as f:
